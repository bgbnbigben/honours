...
%
% Addapted from C. T. Kelley, December 12, 1996
%
%
...
%
% inputs:
%	base vertices of initial simplex = x0 (n x 1 vector)
...
%
    y=x(:,1:n);
    xbart = sum(y,2)'/n;  % centriod of better vertices
    xbar=xbart';
