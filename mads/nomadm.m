...
%    setStochastic          =   Toggle flag to run as stochastic problem (CB)
...
guiFunction = { ...
   'selectProblem','editFile','quitGUI','selectPoll','setStochastic', ...
...
% Set up GUI status bar and panels (or frames boxes, borders, and separators)
try
   ...
   gui.MADSPanel   = uipanel('Parent',gui.fig, ...
                             'Position',[panelLeft, .745, panelWidth, .20], ...
                             'BorderType','beveledout');
   gui.TermPanel   = uipanel('Parent',gui.fig, ...
                             'Position',[panelLeft, .585, panelWidth, .16], ...
                             'BorderType','beveledout');
   gui.MeshPanel   = uipanel('Parent',gui.fig, ...
                             'Position',[panelLeft, .425, panelWidth, .16], ...
                             'BorderType','beveledout');
   gui.FilterPanel = uipanel('Parent',gui.fig, ...
                             'Position',[panelLeft, .265, panelWidth, .16], ...
                             'BorderType','beveledout');
   gui.RSPanel     = uipanel('Parent',gui.fig, ...
                             'Position',[panelLeft, .045, panelWidth, .22], ...
                             'BorderType','beveledout','Visible','off');
   gui.RSBorder    = [];
   ...
   % Status bar
   uicontrol(gui.fig, 'Style','frame','Position',[0, .04, 1, lineHeight], ...
   ...
   gui.RSPanel     = uicontrol(gui.fig,'Style','frame',...
                     'Position',       [panelLeft, .045, panelWidth, .22], ...
                     'ForegroundColor',panelColor,'Visible','off');

   % Borders:  left, right, top, bottom (in that order)
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .265, lineWidth,  panelHeight], ...
      'ForegroundColor',white, 'BackgroundColor',white);
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelRight, .265, lineWidth,  panelHeight], ...
      'ForegroundColor',black, 'BackgroundColor',black);
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .943, panelWidth, lineHeight], ...
      'ForegroundColor',white, 'BackgroundColor',white);
   uicontrol(gui.fig, 'Style','frame',...
      'Position', [panelLeft,  .265, panelWidth, lineHeight], ...
      'ForegroundColor',black, 'BackgroundColor',black);

   % R&S Panel Borders:  left, right, top, bottom (in that order)
   gui.RSBorder(1) = uicontrol(gui.fig, 'Style','frame',...
      'Position', [panelLeft,  .045, lineWidth,  panelRSHeight], ...
      'ForegroundColor',white, 'BackgroundColor',white,'Visible','off');
   gui.RSBorder(2) = uicontrol(gui.fig, 'Style','frame',...
      'Position', [panelRight, .045, lineWidth,  panelRSHeight], ...
      'ForegroundColor',black, 'BackgroundColor',black,'Visible','off');
   gui.RSBorder(3) = uicontrol(gui.fig, 'Style','frame',...
      'Position', [panelLeft,  .262, panelWidth, lineHeight], ...
      'ForegroundColor',white, 'BackgroundColor',white,'Visible','off');
   gui.RSBorder(4) = uicontrol(gui.fig, 'Style','frame',...
      'Position', [panelLeft,  .045, panelWidth, lineHeight], ...
      'ForegroundColor',black, 'BackgroundColor',black,'Visible','off');

   % Three separators in the MADS parameter box (2 per separator)
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .745, panelWidth, lineHeight], ...
      'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .742, panelWidth, lineHeight], ...
      'ForegroundColor','white','BackgroundColor','white');
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .585, panelWidth, lineHeight], ...
      'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .582, panelWidth, lineHeight], ...
      'ForegroundColor','white','BackgroundColor','white');
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .425, panelWidth, lineHeight], ...
      'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(gui.fig, 'Style','frame', ...
      'Position', [panelLeft,  .422, panelWidth, lineHeight], ...
      'ForegroundColor','white','BackgroundColor','white');
end
...
uicontrol(gui.fig, 'String','Optimization Problem: ', ...
      ...
      'Position',     [labelLeft, .955, .21, headerHeight], ...
...
uicontrol(gui.fig, 'String',gui_var.Labels.Parameters.mesh{5}, ...
      'Position',     [labelLeft, .43, labelLongWidth, textHeight], ...
      'ToolTipString', ...
...
uicontrol(gui.fig, 'String',gui_var.Labels.Parameters.other{5}, ...
      'Position',     [labelLeft, .27, labelLongWidth, textHeight], ...
      'ToolTipString', ...
...
for k = 1:length(gui_var.Labels.Parameters.RS)-2
   gui.RSLabel(k) = uicontrol(gui.fig, ...
                  'String',  gui_var.Labels.Parameters.RS{k}, ...
                  'Position',[labelLeft,.26-.03*k,labelLongWidth,textHeight],...
                  'Visible', 'off');
end
gui.RSTermFlag.alpha = uicontrol(gui.fig, ...
      'String',        gui_var.Labels.Parameters.RS{end-1}, ...
      'Style',         'checkbox', ...
      'Position',      [labelLeft, .08, labelLongWidth, textHeight], ...
      'Visible',       'off');
gui.RSTermFlag.noise    = uicontrol(gui.fig, ...
      'String',        gui_var.Labels.Parameters.RS{end}, ...
      'Style',         'checkbox', ...
      'Position',      [labelLeft, .05, labelLongWidth, textHeight], ...
      'Visible',       'off');
...
gui.problem      = uicontrol(gui.fig, 'String',          '', ...
                                      ...
                                      'Position', [.245,.955,.21,headerHeight]);
...
gui.meshRefine     = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .49, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
gui.meshCoarsen    = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .46, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
gui.tolCache       = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .43, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
...
gui.hRho           = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .33, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
gui.ePollXiF       = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .30, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
gui.ePollXiH       = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .27, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center');
gui.RS.s0          = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .23, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.RS.alpha_const = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .20, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.RS.iz_const    = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .17, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.RS.alpha_rho   = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .14, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.RS.iz_rho      = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .11, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.Term.RS_alpha  = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .08, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
gui.Term.RS_noise  = uicontrol(gui.fig, 'ForegroundColor','blue','Position', ...
                     [fieldLongLeft,  .05, fieldShortWidth, textHeight], ...
                     'HorizontalAlignment','center','Visible','off');
...
set([gui.RSLabel], 'ToolTipString','Ranking and Selection Parameters');
...
gui.OptionsMenu.sensorMenu        = uimenu(gui.Menu.Options, 'Position', 3, ...
   'Label',       'Run as Sensor Placement Problem');
gui.OptionsMenu.degeneracyMenu    = uimenu(gui.Menu.Options, 'Position', 4, ...
   'Label',       'Scheme for Handling Degenerate Linear Constraints');
gui.OptionsMenu.removeRedundancy  = uimenu(gui.Menu.Options, 'Position', 5, ...
   'Label',       'Discard Redundant Linear Constraints', ...
   'Callback',    gui.func.uitoggle);
gui.OptionsMenu.runStochastic     = uimenu(gui.Menu.Options, 'Position', 6, ...
   'Label',       'Run as Stochastic Optimization Problem', ...
   'Callback',    gui.func.setStochastic);
gui.OptionsMenu.accelerate        = uimenu(gui.Menu.Options, 'Position', 7, ...
   'Label',       'Accelerate Convergence', ...
   'Callback',    gui.func.uitoggle);
gui.OptionsMenu.TermFlag.relative = uimenu(gui.Menu.Options, 'Position', 8, ...
   'Label',       'Use Relative Termination Tolerance', ...
   'Callback',    gui.func.uitoggle);
gui.OptionsMenu.debugMenu         = uimenu(gui.Menu.Options, 'Position', 9, ...
   'Label',       'Print Debugging Messages to Screen', 'Separator', 'on');
gui.OptionsMenu.saveHistory       = uimenu(gui.Menu.Options, 'Position',10, ...
   'Label',       'Save History to Text File', ...
   'Callback',    gui.func.uitoggle);
gui.OptionsMenu.plotHistoryMenu   = uimenu(gui.Menu.Options, 'Position',11, ...
   'Label',       'Plot History');
gui.OptionsMenu.plotFilter        = uimenu(gui.Menu.Options, 'Position',12, ...
...
gui.MADSMenu.editOtherParam = uimenu(gui.Menu.MADS, 'Position', 5, ...
   ...
   'UserData',    {gui_var.Labels.Parameters.other, ...
                  [gui.hmin; gui.hmax; gui.hRho; ...
                   gui.ePollXiF; gui.ePollXiH]}, ...
   'Callback',    gui.func.edit_gui);
gui.MADSMenu.editRSParam    = uimenu(gui.Menu.MADS, 'Position', 6, ...
   'Label',       'Edit Ranking & Selection Parameters', ...
   'UserData',    {gui_var.Labels.Parameters.RS, ...
                  [gui.RS.s0; gui.RS.alpha_const; gui.RS.iz_const; ...
                   gui.RS.alpha_rho; gui.RS.iz_rho; gui.Term.RS_alpha; ...
                   gui.Term.RS_noise]}, ...
   'Callback',    gui.func.edit_gui);
...
if (pFile)
   ...
   hasClosedConst = exist([nameProblem,gui_var.FileExt.X,'.m'],'file');
   ...
   set(gui.ProblemMenu.edit(3),    'Visible', onoff{1+~hasClosedConst});
   set(gui.ProblemMenu.edit(4),    'Visible', onoff{1+~isConstrained});
   set(gui.ProblemMenu.edit(5),    'Visible', onoff{1+~isMVP});
   set(gui.ProblemMenu.edit(6),    'Visible', onoff{1+~hasUserParam});
...
%*******************************************************************************
% setStochastic: Turn on and off flag for running as a stochastic problem.
% ------------------------------------------------------------------------------
% Called by: nomadm_gui (callback:MADS-->Run as Stochastic Optimization Problem)
%            updateScreen
% VARIABLES:
%  h                            = handle of calling object
%  gui                          = structure of NOMADm object handles
...
%    .RS                        =   structure of handles for R&S parameters
%    .RSLabel                   =   handles of R&S parameter display labels
%    .Term                      =   handle of termination criteria
%      .RS_alpha                =     handle for R&S alpha termination criteria
%      .RS_iz                   =     handle for R&S indifference zone criteria
%  RS                           = vector of R&S handles
%  runStochastic                = flag indicating if problem is stochastic
%*******************************************************************************
function setStochastic(h,event)

% Retrieve the handles of objects used in stochastic problems
gui = getappdata(gcf,'gui');
RS  = [gui.MADSMenu.editRSParam; gui.RSPanel; gui.RSLabel(:); ...
       gui.RSBorder(:); gui.Term.RS_alpha; gui.Term.RS_noise];
rsfield = fieldnames(gui.RS);
for k = 1:length(rsfield)
   RS = [RS; gui.RS.(rsfield{k})]; %#ok
end
RS = [RS; gui.RSTermFlag.alpha; gui.RSTermFlag.noise];

% Toggle stochastic options on/off
if ~isempty(h) && (h == gui.OptionsMenu.runStochastic)
   uitoggle(h);
end
set(RS, 'Visible', get(gui.OptionsMenu.runStochastic,'Checked'));
return
...
%*******************************************************************************
function clearRuns(h,event,clearall)
...
if clearall || ~gui_var.runCount
   ...
   set([gui.RunMenu.clear; gui.RunMenu.clear1; gui.CacheMenu.save],'Enable', 'off');
...
Options.Term.RS_alpha = str2double(get(gui.Term.RS_alpha,'String'));
Options.Term.RS_noise = str2double(get(gui.Term.RS_noise,'String'));
if ~Options.RSTermFlag.alpha, Options.Term.RS_alpha = Inf; end
if ~Options.RSTermFlag.noise, Options.Term.RS_noise = Inf; end
...
try
   ...
   panelColor = get(guiEdit.fig,'DefaultUIControlBackgroundColor');
   uicontrol(guiEdit.fig, 'Style','frame','Position',[0, 0, 1, 1], ...
      'ForegroundColor',panelColor,'BackgroundColor',panelColor);
end
...
%      .sfile        =   handle for string name of surrogate file
...
try
   ...
   uicontrol(guiSearch.fig, 'Style', 'text', ...
       'String', 'Number of Search Types: ', ...
       'Position', [0 .905 .20 .06]);
   guiSearch.n = uicontrol(guiSearch.fig, ...
       'Style',           'popupmenu', ...
       'String',          {'0','1','2','3','4','5','6','7','8'}, ...
       'BackgroundColor', 'white', ...
       'Value',           gui_var.Options.nSearches+1, ...
       'Position',        [.18 .9125 .05 .06], ...
       'Callback',        gui.func.modifySearchScreen);
   uicontrol(guiSearch.fig, 'Style', 'text', ...
       'String', 'Surrogate Optimizer: ', ...
       'Position', [.24 .905 .15 .06]);
   guiSearch.SurOptimizer = uicontrol(guiSearch.fig, ...
       'Style',           'popupmenu', ...
       'String',          gui_var.Labels.optimizer, ...
       'BackgroundColor', 'white', ...
       'Value',           gui_var.Choice.optimizer, ...
       'Position',        [.39 .9125 .32 .06]);
   guiSearch.mvp1Surrogate = uicontrol(guiSearch.fig, ...
       'Style',           'checkbox', ...
       'String',          'Use single surrogate for MVPs', ...
       'Value',           gui_var.Options.mvp1Surrogate, ...
       'Position',        [.75 .9125 .23 .06]);
end
...
uicontrol(guiSearch.fig, 'Style', 'text', ...
    ...
    'Position', [.05, .80, .27, .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   '# Iterations', ...
    'Position', [.33, .80, .10, .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   '# Points', ...
    'Position', [.44, .80, .08, .06]);
uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   'Complete', ...
    'Position', [.53, .80, .06, .06]);
guiSearch.Labels.sfile = uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   'Surrogate File', ...
    'Position', [.60, .80, .09, .06]);
guiSearch.Labels.file  = uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   'User File', ...
    'Position', [.70, .80, .14, .06]);
guiSearch.Labels.param = uicontrol(guiSearch.fig, 'Style', 'text', ...
    'String',   'Apply Surrogate to:', ...
    'Position', [.85, .80, .14, .06]);
...
for k = 1:gui_var.maxSearches
   if k <= nSearches
      isSurrogate(k) = ~isempty(findstr(gui_var.Labels.search{ ...
                    get(guiSearch.Screen(k).type,'Value')},'Surrogate'));
      hasUFile(k) = ~isempty(deblank(get(guiSearch.Screen(k).file,'String')));
      hasSFile(k) = ~isempty(deblank(get(guiSearch.Screen(k).sfile,'String')));
...
[k,previousType,local,merit,recal] = deal(userData{:});
...
case {'Custom','CustomS'}
   ...
   if (sName)
      ...
      set(gcbo, 'UserData',{k,newValue,local,merit,recal});
   else
...
if loadSearch
   ...
   for k = 1:gui_var.Options.nSearches
      ...
      Search.sfile    = fullfile(...
                        get(guiSearch.Screen(k).sfile, 'UserData'), ...
                        get(guiSearch.Screen(k).sfile, 'String'));
      ...
      Search.recal    = gui_var.Options.Search(k).recal;
      Search.recal    = UserData{5};
...
try
   ...
   panelColor = get(guiPoll.fig,'DefaultUIControlBackgroundColor');
   uicontrol(guiPoll.fig, 'Style','frame','Position',[0, 0, 1, 1], ...
      'ForegroundColor',panelColor,'BackgroundColor',panelColor);

   % Figure window shading to make it appear recessed
   uicontrol(guiPoll.fig, 'Style','frame','Position', [0, 0, 1, .004],    ...
             'ForegroundColor','white','BackgroundColor','white');
   uicontrol(guiPoll.fig, 'Style','frame','Position', [.997, 0, .003, 1], ...
             'ForegroundColor','white','BackgroundColor','white');
   uicontrol(guiPoll.fig, 'Style','frame','Position', [0, .996, 1, .004], ...
             'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(guiPoll.fig, 'Style','frame','Position', [0, 0, .003, 1],    ...
             'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
end
...
%    .done           =   handle for Done pushbutton
%    .cancel         =   handle for Cancel pushbutton   
%  loadPoll          = flag indicating if Poll options will be loaded
%*******************************************************************************
function loadPollOptions(h,event)
...
if loadPoll
   ...
   gui_var.Options.Poll.order   = ...
                        gui_var.Types.pollOrder{gui_var.Choice.Poll.order};
   ...
   gui_var.Options.EPoll.order  = ...
                        gui_var.Types.pollOrder{gui_var.Choice.EPoll.order};
   ...
   set(gui.pollStrategy,'String', ...
       gui_var.Labels.poll{gui_var.Choice.Poll.type});
   set(gui.pollOrder,   'String', ...
       gui_var.Labels.pollOrder{gui_var.Choice.Poll.order});
   set(gui.pollCenter,  'String', ...
       gui_var.Labels.pollCenter{gui_var.Choice.Poll.center});
end
...
try
   ...
   panelColor = get(guiCMAES.fig,'DefaultUIControlBackgroundColor');
   uicontrol(guiCMAES.fig, 'Style','frame','Position',[0, 0, 1, 1], ...
      'ForegroundColor',panelColor,'BackgroundColor',panelColor);
end
...
%    .recombWeights    =     string choice of recombination weighting strategy
%*******************************************************************************
function loadCMAESOptions(h,event,loadCMAES,k)
...
%    .daceTheta         =   correlation parameter initial guess
%    .daceIsotropic     =   checkbox for isotropic correlations
%    .daceSetBounds     =   checkbox for manually setting bounds on theta
%    .lower             =   field for entering lower bound for theta
...
%      .setBounds       =   flag for manually setting theta bounds
%*******************************************************************************
...
try
   ...
   panelColor = get(guiSurrogate.fig,'DefaultUIControlBackgroundColor');
   uicontrol(guiSurrogate.fig, 'Style','frame','Position',[0, 0, 1, 1], ...
      'ForegroundColor',panelColor,'BackgroundColor',panelColor);
end
...
uicontrol(guiSurrogate.fig, ...
      ...
      'HorizontalAlignment', 'right', ...
      'FontSize',            .6, ...
      'Position',            [.02 .615 .34 .08]);
guiSurrogate.recal         = uicontrol(guiSurrogate.fig, ...
      'Style',               'popupmenu', ...
      'String',              gui_var.Labels.recalibration, ...
      'BackgroundColor',     'white', ...
      'Value',               gui_var.Options.Search(k).recal, ...
      'Position',            [.37 .62 .60 .09]);
guiSurrogate.local         = uicontrol(guiSurrogate.fig, ...
      'Style',               'checkbox', ...
      'String',              'Restrict Model to Trust Region', ...
      'Value',               gui_var.Options.Search(k).local, ...
...
%    .Screen          =   handles for Search figure window objects
%      .type          =     type of Search
%      .sfile         =     name of optional surrogate file
...
%    .kernel          =   kernel function handle
%*******************************************************************************
function loadSurrogateOptions(h,event,loadSurrogate,k)
...
if isempty(loadSurrogate)
   ...
   case 'DACE'
      ...
      dace.theta = str2double(get(guiSurrogate.daceTheta,'String'));
      dace.lower = str2double(get(guiSurrogate.lower,'String'));
      dace.upper = str2double(get(guiSurrogate.upper,'String'));
      dace.isotropic = get(guiSurrogate.daceIsotropic,'Value');
      dace.setBounds = get(guiSurrogate.daceSetBounds,'Value');
      gui_var.Options.dace(k) = dace;
      set(guiSearch.Screen(k).sfile,'UserData','','String',dace.reg);
   case 'NW'
   ...
   case 'RBF'
      ...
      set(guiSearch.Screen(k).sfile,'UserData','','String',rbf.kernel);
   end
   setappdata(fig,'gui_var',gui_var);
...
% Calls:     updateSearchLabels, setStochastic
% VARIABLES:
...
set(gui.RSTermFlag.alpha, 'Value', Options.RSTermFlag.alpha);
set(gui.RSTermFlag.noise, 'Value', Options.RSTermFlag.noise);
field = fieldnames(gui.RS);
for k = 1:length(field)
...
% Set the visibility of objects used in stochastic problems
setStochastic(gcbo,1);
return
...
%    .nIter       =   number of iterations to perform Search
%    .nPoints     =   number of Search points
%    .sfile       =   optional user surrogate file
%    .file        =   optional user file defining Search
%  k              = Search type counter
...
for k = 1:nSearches
   if isfield(Search(k),'sfile')
      [ignore,sFile] = fileparts(Search(k).sfile); %#ok
   end
%   [ignore,uFile] = fileparts(Search(k).file);
   ...
   case {'DACE'}
      label{k} = ['DACE Surrogate: ',   sFile];
   case {'NW'}
      label{k} = ['N-W Surrogate: ',    sFile];
   case {'RBF'}
      label{k} = ['RBF Surrogate: ',    sFile];
   case {'SPS-DACE'}
      label{k} = ['SPS / DACE: ',       uFile, ' / ', sFile];
   case {'SPS-NW'}
      label{k} = ['SPS / N-W: ',        uFile, ' / ', sFile];
   case {'SPS-RBF'}
      label{k} = ['SPS / RBF: ',        uFile, ' / ', sFile];
   case {'Custom'}
...
try
   uipanel('Parent',fig,'Position',[0,  0,  1,.68], ...
                        'BorderType','beveledin','BackgroundColor',[.8 .8 .8]);
   uipanel('Parent',fig,'Position',[0, .68,.5,.37], ...
                        'BorderType','beveledin','BackgroundColor',[.8 .8 .8]);
   uipanel('Parent',fig,'Position',[.5,.68,.5,.37], ...
                        'BorderType','beveledin','BackgroundColor',[.8 .8 .8]);
catch
   uicontrol(fig, 'Style','frame','Position', [0, .676, 1, .004],...
      'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(fig, 'Style','frame','Position', [0, .68, 1, .004],...
      'ForegroundColor','white','BackgroundColor','white');
   uicontrol(fig, 'Style','frame','Position', [.5, .68, .003, .37], ...
      'ForegroundColor',[.4 .4 .4],'BackgroundColor',[.4 .4 .4]);
   uicontrol(fig, 'Style','frame','Position', [.497, .68, .003, .37], ...
      'ForegroundColor','white','BackgroundColor','white');
end
